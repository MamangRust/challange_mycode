...
import { getCodewars } from "@/utils/mdx";

const POSTS_PER_PAGE = 5;

const Codewars = () => {
  const { data: codewars = [], isLoading } = useQuery({
    queryKey: ['codewars'],
    queryFn: getCodewars,
  });
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        {isLoading ? (
          <div className="text-center text-gray-500">Loading codewars...</div>
        ) : (
          <>
